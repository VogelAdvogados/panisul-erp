...
import { Plus, ChefHat, Receipt, Upload } from 'lucide-react';
import Link from 'next/link';

const actions = [
    { label: 'Nova Venda', icon: Plus, href: '/vendas/nova', color: 'bg-green-500 hover:bg-green-600' },
    { label: 'Nova Produção', icon: ChefHat, href: '/operacoes/registrar', color: 'bg-blue-500 hover:bg-blue-600' },
