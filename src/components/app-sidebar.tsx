...
const menuItems = [
    ...
    { href: '/clientes', label: 'Clientes', icon: Users, description: "Gestão e histórico de clientes" },
    { href: '/cadastros', label: 'Cadastros', icon: FileText, description: "Produtos, insumos, fornecedores, vendedores e funcionários" },
